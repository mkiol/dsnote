...
if(BUILD_WHISPERCPP)
    ...
    if(arch_x8664)
        install(FILES "${external_lib_dir}/libwhisper-fallback1.so.${whispercpp_ver}" DESTINATION ${lib_install_dir})
        install(FILES "${external_lib_dir}/libwhisper-fallback1.so.1" DESTINATION ${lib_install_dir})
        install(FILES "${external_lib_dir}/libwhisper-fallback1.so" DESTINATION ${lib_install_dir})
        if(BUILD_WHISPERCPP_CLBLAST)
            ...
            install(FILES "${external_lib_dir}/libwhisper-clblast.so.${whispercpp_ver}" DESTINATION ${lib_install_dir})
            install(FILES "${external_lib_dir}/libwhisper-clblast.so.1" DESTINATION ${lib_install_dir})
        ...
        if(BUILD_WHISPERCPP_CUBLAS)
            ...
            install(FILES "${external_lib_dir}/libwhisper-cublas.so.${whispercpp_ver}" DESTINATION ${lib_install_dir})
            install(FILES "${external_lib_dir}/libwhisper-cublas.so.1" DESTINATION ${lib_install_dir})
        ...
        if(BUILD_WHISPERCPP_HIPBLAS)
            ...
            install(FILES "${external_lib_dir}/libwhisper-hipblas.so.${whispercpp_ver}" DESTINATION ${lib_install_dir})
            install(FILES "${external_lib_dir}/libwhisper-hipblas.so.1" DESTINATION ${lib_install_dir})
        ...
        if(BUILD_WHISPERCPP_OPENVINO)
            ...
            install(FILES "${external_lib_dir}/libwhisper-openvino.so.${whispercpp_ver}" DESTINATION ${lib_install_dir})
            install(FILES "${external_lib_dir}/libwhisper-openvino.so.1" DESTINATION ${lib_install_dir})
            install(FILES "${external_lib_dir}/libwhisper-openvino.so" DESTINATION ${lib_install_dir})
        endif()
    endif()
endif()
