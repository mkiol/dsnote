...
%define __requires_exclude ^libstt.*|libkenlm.*|libtensorflowlite.*|libtflitedelegates.*|libopenblas.*|libwhisper*|libggml*|libparakeet*|libbergamota*|libvosk.*|libonnxruntime.*|libRHVoice*|libaprilasr.*$
