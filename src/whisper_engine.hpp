...
typedef void (*whisper_new_segment_callback)(void * ctx, void * state, int n_new, void * user_data);

// Progress callback
typedef void (*whisper_progress_callback)(void * ctx, void * state, int progress, void * user_data);

// Encoder begin callback
// If not NULL, called before the encoder starts
// If it returns false, the computation is aborted
typedef bool (*whisper_encoder_begin_callback)(void * ctx, void * state, void * user_data);
...
class whisper_engine : public stt_engine {
   ...
   private:
    ...
    struct whisper_api {
        ...
        const char* (*whisper_version)() = nullptr;
        void (*whisper_log_set)(ggml_log_callback log_callback,
        ...
        auto ok() const {
            return whisper_init_from_file_with_params &&
                   ...
                   whisper_context_default_params && whisper_full_lang_id &&
